...
class EndScreen(Screen):
    ...
    def setposition(self) -> None:
        ...
        self.layout_.addWidget(self.widgets.winner, 10, alignment=Qt.AlignHCenter)
        self.layout_.addWidget(self.widgets.screen_, 1, alignment=Qt.AlignHCenter)
        self.layout_.addWidget(self.widgets.quit, 10, alignment=Qt.AlignHCenter)
        self.layout_.addStretch(1)
